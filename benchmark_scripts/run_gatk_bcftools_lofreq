...
python ../cds2peptides_v2.py ../epitope_DBs/IEDB_neoepitopes_per_ENST2.tab ../epitope_DBs/TSNAdb_frequent_ICGC_per_ENST3.tab ../epitope_DBs/TSNAdb_frequent_TCGA_per_ENST3.tab ${n}.hapCall.neoCDS.fasta ${n}_hapCall
python ../cds2peptides_v2.py ../epitope_DBs/IEDB_neoepitopes_per_ENST2.tab ../epitope_DBs/TSNAdb_frequent_ICGC_per_ENST3.tab ../epitope_DBs/TSNAdb_frequent_TCGA_per_ENST3.tab ${n}.lofreq.neoCDS.fasta ${n}_lofreq
python ../cds2peptides_v2.py ../epitope_DBs/IEDB_neoepitopes_per_ENST2.tab ../epitope_DBs/TSNAdb_frequent_ICGC_per_ENST3.tab ../epitope_DBs/TSNAdb_frequent_TCGA_per_ENST3.tab ${n}.bcftools.neoCDS.fasta ${n}_bcftools
