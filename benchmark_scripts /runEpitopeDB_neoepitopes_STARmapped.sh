...
module purge
~/usr/bin/mudskipper/target/release/mudskipper shuffle --bam ${sample}.dedup.null.bam  -t 2 --out ${sample}.shuffle.bam
~/usr/bin/mudskipper/target/release/mudskipper bulk -p --alignment ${sample}.shuffle.bam --index /data/hemberg/shared_resources/genomes/human/GRCh38.p13.107.mskdb -t $cores --out ${sample}.STAR2CDS.bam
rm ${sample}.shuffle.bam
