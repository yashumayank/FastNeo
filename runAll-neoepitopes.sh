...
bedtools intersect -C -a ${pathDB}TransposElements/TE_antigenRegions.bed -b ${sample}.nullomers.union2.TE.bam |awk '$7>1' >  ${sample}_TE_neoepitopes_readCounts.tsv
wait
