...
#find coverage for each nullomer correspoding to specific fusion ; filter reads with (MAPQ < minMAPQ AND (read_length <= (clipped_length*3) OR alignment_score <= expected_score) ; minMAPQ is 10 for epitopeDB neoepitopes and 30 for fusions
