...
bowtie2 -x ${pathDB}ChimerKB_bowtie -p $cores --very-sensitive --no-discordant --mp 3 -1 ${sample}_1.fastq.neomers.union -2 ${sample}_2.fastq.neomers.union -S ${sample}.neomers.union.sam
